...
SUBROUTINE advec_cell_kernel(g_mic_device,&
                             x_min,       &
                             x_max,       &
                             y_min,       &
                             y_max,       &
...
!DIR$   in(post_ener    :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(pre_mass     :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(post_mass    :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(advec_vol    :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(ener_flux    :length(0) alloc_if(.false.) free_if(.false.))
!$OMP PARALLEL
