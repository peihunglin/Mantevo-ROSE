...
!$OMP map(soundspeed,xvel0,xvel1,yvel0,yvel1,vol_flux_x,mass_flux_x) &
!$OMP map(vol_flux_y,mass_flux_y,volume,xarea,yarea,cellx,celly,celldx,celldy)&
!$OMP map(vertexx,vertexdx,vertexy,vertexdy,left_snd_buffer,left_rcv_buffer) &
!$OMP map(right_snd_buffer,right_rcv_buffer,bottom_snd_buffer,bottom_rcv_buffer,top_snd_buffer,top_rcv_buffer)
