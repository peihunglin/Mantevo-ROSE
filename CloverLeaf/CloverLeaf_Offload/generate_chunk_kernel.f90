...
SUBROUTINE generate_chunk_kernel(g_mic_device,x_min,x_max,y_min,y_max, &
                                 vertexx,                 &
                                 vertexy,                 &
                                 cellx,                   &
                                 celly,                   &
...
!DIR$   in(state_density,state_energy,state_xvel,state_yvel) &
!DIR$   in(state_xmin,state_xmax,state_ymin,state_ymax,state_radius) &
!DIR$   in(state_geometry,g_rect,g_circ,number_of_states) &
