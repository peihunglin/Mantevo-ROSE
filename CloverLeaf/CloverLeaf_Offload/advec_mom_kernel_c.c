...
void advec_mom_kernel_c_(int *g_mic_device,int *xmin,int *xmax,int *ymin,int *ymax,
                      double *xvel1,
                      double *yvel1,
                      double *mass_flux_x,
                      double *vol_flux_x,
...
#pragma offload target(mic:*g_mic_device) \
   in(vel1         :length(0) alloc_if(0) free_if(0)) \
   ...
   in(celldx       :length(0) alloc_if(0) free_if(0)) \
   in(celldy       :length(0) alloc_if(0) free_if(0)) \
   in(mom_flux     :length(0) alloc_if(0) free_if(0)) \
   in(advec_vel    :length(0) alloc_if(0) free_if(0)) \
   in(node_flux    :length(0) alloc_if(0) free_if(0)) \
   in(node_mass_post :length(0) alloc_if(0) free_if(0)) \
   in(node_mass_pre  :length(0) alloc_if(0) free_if(0)) \
