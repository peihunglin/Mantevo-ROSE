...
// number of atoms in the basis
  int nb = 4;
  real3 basis[4] = {{(0.25), (0.25), (0.25)}, {(0.25), (0.75), (0.75)}, {(0.75), (0.25), (0.75)}, {(0.75), (0.75), (0.25)}};
...
// set total atoms in simulation
  ...
  s -> atoms -> nGlobal == nb * nx * ny * nz?((void )0) : __assert_fail("s->atoms->nGlobal == nb*nx*ny*nz","initAtoms.c",108,__PRETTY_FUNCTION__);
}
