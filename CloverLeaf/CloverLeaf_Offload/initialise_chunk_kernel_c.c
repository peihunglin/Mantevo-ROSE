...
void initialise_chunk_kernel_c_(int *g_mic_device,int *xmin,int *xmax,int *ymin,int *ymax,
                                double *minx,
                                double *miny,
                                double *dx,
                                double *dy,
...
#pragma offload target(mic:g_mic_device) \
   in(vertexx   :length(0) alloc_if(0) free_if(0)) \
   in(vertexdx  :length(0) alloc_if(0) free_if(0)) \
   in(vertexy   :length(0) alloc_if(0) free_if(0)) \
   in(vertexdy  :length(0) alloc_if(0) free_if(0)) \
   in(cellx     :length(0) alloc_if(0) free_if(0)) \
   in(celldx    :length(0) alloc_if(0) free_if(0)) \
   in(celly     :length(0) alloc_if(0) free_if(0)) \
