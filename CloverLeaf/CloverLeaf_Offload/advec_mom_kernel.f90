...
SUBROUTINE advec_mom_kernel(g_mic_device,x_min,x_max,y_min,y_max,   &
                            xvel1,             &
                            yvel1,             &
                            mass_flux_x,       &
                            vol_flux_x,        &
...
!DIR$   in(vel1         :length(0) alloc_if(.false.) free_if(.false.)) &
...
!DIR$   in(mom_flux     :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(advec_vel    :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(node_flux    :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(node_mass_post :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(node_mass_pre  :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(post_vol     :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   in(pre_vol     :length(0) alloc_if(.false.) free_if(.false.))
