...
SUBROUTINE calc_dt_kernel(g_mic_device,x_min,x_max,y_min,y_max,             &
                          g_small,g_big,dtmin,                 &
                          dtc_safe,                            &
                          dtu_safe,                            &
                          dtv_safe,                            &
...
!DIR$   in(dt_min       :length(0) alloc_if(.false.) free_if(.false.)) &
!DIR$   inout(dt_min_val) &
!DIR$   IN(g_small,g_big)
